...
// 	const [pacingStyle, setPacingStyle] = useLocalPersistState(PACING_PULSE, "pacing-style");

// 	// local persist difficulty
// 	const [difficulty, setDifficulty] = useLocalPersistState(DEFAULT_DIFFICULTY, "difficulty");

// 	// local persist difficulty
// 	const [language, setLanguage] = useLocalPersistState(ENGLISH_MODE, "language");
...
// 			return wordsGenerator(verse, DEFAULT_WORDS_COUNT, difficulty, ENGLISH_MODE);
// 		}
...
// 	const words = useMemo(() => {
// 		return wordsDict.map((e: any) => e.val);
// 	}, [wordsDict]);

// 	const wordsKey = useMemo(() => {
// 		return wordsDict.map((e: any) => e.key);
// 	}, [wordsDict]);
...
// 			if (language === ENGLISH_MODE) {
// 				// const generatedEng = wordsGenerator(verse);
// 				const verses = [];
...
// 							currCharCorrectCount + currCharMissingCount + currCharIncorrectCount;
...
// 									<span key={"word" + idx} className={getCharClassName(i, idx, char, word)}>
// 										{char}
// 									</span>
// 								))}
...
// 								<IconButton
// 									onClick={() => {
// 										reset(countDownConstant, DEFAULT_DIFFICULTY, language, false);
// 									}}
// 								>
// 									<Tooltip
// 										title={
...
// 										<span className={getLanguageButtonClassName(ENGLISH_MODE)}>eng</span>
// 									</Tooltip>
// 								</IconButton>
// 								<IconButton
// 									onClick={() => {
...
// 										<span className={getLanguageButtonClassName(CHINESE_MODE)}>chn</span>
// 									</Tooltip>
// 								</IconButton>
// 							</Box>
// 						)}
...
// 						<span className="key-type">Space</span> <span className="key-note">to redo</span>
// 					</div>
// 					<div>
// 						<span className="key-note"> press </span>
// 						<span className="key-type">Tab</span> <span className="key-note">/</span>{" "}
// 						<span className="key-type">Enter</span> <span className="key-note">to restart</span>
// 					</div>
// 					<span className="key-note"> press </span>
// 					<span className="key-type">any key </span> <span className="key-note">to exit</span>
// 				</DialogTitle>
// 			</Dialog>
// 		</div>
// 	);
